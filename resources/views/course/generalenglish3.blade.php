            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [36]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Standard Monday to Friday
                        </td>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [37]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Standard Monday to Friday
                        </td>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [38]) }}">Enroll</a></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="20%">Morning</td>
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [39]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Intensive Monday to Friday
                        </td>
                        <td width="20%">Afternoon</td>
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [40]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        ...
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [41]) }}">Enroll</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
