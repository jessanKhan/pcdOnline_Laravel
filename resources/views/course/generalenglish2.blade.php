    ...
    <div class="main">
        ...
        <div class="course-fees">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        <td width="50%">General English For Beginners Standard Monday to Friday
                        </td>
                        <td width="20%">Morning</td>
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [30]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Standard Monday to Friday
                        </td>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [31]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Standard Monday to Friday
                        </td>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [32]) }}">Enroll</a></td>
                    </tr>

                    <tr>
                        <td width="50%">General English For Beginners Intensive Monday to Friday
                        </td>
                        <td width="20%">Morning</td>
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [33]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Intensive Monday to Friday
                        </td>
                        <td width="20%">Afternoon</td>
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [34]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Weekends
                        </td>
                        <td width="20%">Weekends Morning</td>
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [35]) }}">Enroll</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
