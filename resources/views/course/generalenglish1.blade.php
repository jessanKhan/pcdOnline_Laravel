                ...
                <div class="signup-content col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="COURSE FORMAT">
                            ...
                            <p style="color: black">
                                This course is designed for under- and post-graduate students, as well as scientific and technical professionals (NFQ levels 4) and                                   delivered Virtual Classroom environments.
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [24]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">General English For Beginners Standard Monday to Friday
                        </td>
