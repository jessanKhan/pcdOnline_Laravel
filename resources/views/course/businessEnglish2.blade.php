                ...
                <div class="col-md-12">
                    <div class="course-banner">
                        <img class="rounded mx-auto d-block" style="margin-top: 20px"
                            src="{{ asset('assets/images/b eng 2.jpg') }}" alt="" />
                    </div>
                </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [47]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">Business English For Beginners Standard Monday to Friday
                        </td>
                        ...
                        <td width="20%">€385</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [48]) }}">Enroll</a></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="20%">Morning</td>
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [49]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        <td width="50%">Business English For Beginners Intensive Monday to Friday
                        </td>
                        ...
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [50]) }}">Enroll</a></td>
                    </tr>
                    <tr>
                        ...
                        <td width="20%">€420</td>
                        <td width="10%"><a class="btn btn-success" href="{{ route('add', [51]) }}">Enroll</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
